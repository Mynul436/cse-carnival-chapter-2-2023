                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("bookappointment::text.name")
                            </th>
                            <th>
                                @lang("bookappointment::text.slug")
                            </th>
                            <th>
                                @lang("bookappointment::text.updated_at")
                            </th>
                            <th>
                                @lang("bookappointment::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("bookappointment::text.action")
                            </th>
                        </tr>
                    </thead>
